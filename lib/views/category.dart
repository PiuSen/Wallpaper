...
class Category extends StatefulWidget {
 ...
 Category({required this.CategoryName}); //const Category({super.key});
...
class _CategoryState extends State<Category> {
  ...
  getCategoryWallpaper()async{
    String url="https://api.pexels.com/v1/search?query=${widget.CategoryName}&per_page=30&page=1";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child:WallpaperList(photosModel: photos,context: context ) ,
        ),
      );
